...
* [Google's Project Aristotle](https://rework.withgoogle.com/en/guides/understanding-team-effectiveness/) - What makes a team effective?
...
* 틀리기 쉬운 한국어
    * 전셋값, 상숫값, 변숫값, 최댓값, 최솟값, 양숫값, 음숫값, 실숫값, 고윳값, 기댓값, 경곗값, 유횻값, 초깃값, 임곗값, 결괏값, 목푯값, 최젓값, 나잇값, **해시값** ([링크](https://wikidocs.net/80784))
    * 접미사 '-별'은 앞말과 띄어쓰지 않음 ([링크](https://wikidocs.net/67214))
    * '-ㄹ수록'의 '수록'은 앞말과 띄어쓰지 않음 ([링크](https://brunch.co.kr/@unparanmanjang/13))
    * 가치 있다, 의미 있다, 쓸모 있다, 앉아 있다, 자고 있다 ([링크](https://aboooks.tistory.com/39))
* 헷갈리는 영어
    * 어떤 파라미터를 어떤 값으로 설정할 때는 set *something* **to** *some-number*
