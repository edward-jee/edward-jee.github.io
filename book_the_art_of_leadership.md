# 책 '실리콘밸리 리더십'을 내가 번역한다면

(September 2024)

연휴에, 옛날에 사 두고 대충 읽다 만 책을 다시 집어 들었다.
...
이 책은 실리콘밸리 스타일의 회사에서 엔지니어링 매니저로서의 커리어를 밟아가는 사람들에게 유용한 팁들을 알려준다. 커리어 성장 단계에 따라, 1장에서 매니저를 위한 팁들, 2장에서 매니저들의 매니저를 위한 팁들, 3장에서 임원 급을 위한 팁들을 볼 수 있다. 각 팁은 짧은 챕터 하나로 되어 있다.

(영미권 엔지니어들이 쓴 책이 종종 그러하듯) 다소 장황한 부분이 있고 어떤 것들은 꽤 주관적인 견해인 것 같기도 하지만, 비교적 읽기 편하고, 건질만한 유용한 도구들이 있다.

문제는, 이해하기 어렵게 번역된 부분이 여럿 있다는 것이다. 번역하신 분이 실리콘밸리 엔지니어링 문화를 직접 경험해보지 않으셨을 것이기에, 어느 정도의 한계가 있으셨으리라 짐작된다.

이 책을 추천할 때 같이 전달하기 위해, 책에 했던 메모들을 아래에 옮겨 둔다.
